...
#include <vector>
#include <memory>
#include "GLViewOptimization.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewOptimization > glView( Aftr::GLViewOptimization::New( args ) );
